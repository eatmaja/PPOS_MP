        ...
        <?= form_open("$controller_name/selectCustomer", ['id' => 'select_customer_form', 'class' => 'form-horizontal']) ?>
            ...
            <?php } else { ?>
                <div class="form-group" id="select_customer">
                    ...
                    <!--
<<<<<<< HEAD
                    <button class="btn btn-info btn-sm modal-dlg disabled" data-btn-submit="<?= lang('Common.submit') ?>" data-href="<?= "customers/view" ?>" title="<?= lang(ucfirst($controller_name) . ".new_customer") ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // 🔒 Nonaktifkan semua input diskon per item
        ...
        $('[name="discount_toggle"]').prop('disabled', true);
    });
